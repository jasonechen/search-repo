...
<?php 
	...
	<?php echo $form->errorSummary($model); ?>
       <?php echo $form->hiddenField($model,'transType',array('value'=>'S')); ?> 
...
<div class="registerform">
	...
	<?php echo $form->textField($model,'LastName',array('size'=>15,'maxlength'=>50)); ?>
       ...
       <tr><td>     
		...
		<?php echo $form->error($model,'email'); ?>
            ...
            <td style="font-style: italic; font-size: 12px">Email address must be *.edu</td>
        </tr> 
		...
		<?php echo $form->error($model,'password_unhash_repeat'); ?>
                   ...
                   <tr><td>     
   		<?php echo $form->label($model,'schoolType',array('label'=>'Student Type')); ?>
            </td>
            <td>
	...
	<?php echo $form->error($model,'termagree', array('label'=>'Please check box to agree to Terms and Conditions')); ?>
