		...
		<tr class="templateContent">  	
			<td>			
				<table width="100%" height="100" style="border:#459E00 1px solid; background:#D2F4D3;padding:10px;">
					...
					<tr>
						<td><?php echo CHtml::dropdownList('VolunteerProfile[{0}][year_begin]','',VolunteerProfile::$YearParticipateArray,array('prompt'=>'Enter Begin Year','class'=>'req from')); ?>
						<?php $this->ErrorDiv('VolunteerProfile_{0}_year_beginError','From'); ?>
						</td>
						<td><?php echo CHtml::dropdownList('VolunteerProfile[{0}][year_end]','',VolunteerProfile::$YearParticipateArray,array('prompt'=>'Enter End Year','class'=>'req to')); ?>
					...
					<thead>
						<td colspan="3"><?php echo $form->labelEx($volunteerProfile,'comments',array('label'=>'Notes/Comments')); ?></td>
					</thead>
					<tr>
						<td colspan="3"><?php echo CHtml::textField('VolunteerProfile[{0}][comments]','',array('size'=>80,'maxlength'=>100)); ?></td>
					</tr>
		...
		<?php for($i = 0 ; $i< count($volunteer); $i++){ ?>
			...
			<td>			
				<table width="100%" height="100" style="border:#459E00 1px solid; background:#D2F4D3;padding:10px;">
					...
					<tr >
						<td><?php echo CHtml::dropdownList('VolunteerProfile[{'.$i.'}][year_begin]',$volunteer[$i]->year_begin,VolunteerProfile::$YearParticipateArray,array('prompt'=>'Enter Begin Year','class'=>'req from')); ?>
							<?php $this->ErrorDiv('VolunteerProfile_'.$i.'_year_beginError','From'); ?>

						</td>
						<td><?php echo CHtml::dropdownList('VolunteerProfile[{'.$i.'}][year_end]',$volunteer[$i]->year_end,VolunteerProfile::$YearParticipateArray,array('prompt'=>'Enter End Year','class'=>'req to')); ?>
					...
					<tr>
						<td colspan="3"><?php echo CHtml::textField('VolunteerProfile[{'.$i.'}][comments]',$volunteer[$i]->comments,array('size'=>80,'maxlength'=>100)); ?></td>
					</tr>
					<!--GIve the Break to for Space between each table-->
					<br/>
				</table>
