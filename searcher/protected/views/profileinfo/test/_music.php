		...
		<tr class="templateContent">  	
			<td>			
				<table width="100%" height="100" style="border:#459E00 1px solid; background:#D2F4D3;padding:10px;" >
					...
					<thead>
						<td colspan="4"><?php echo $form->labelEx($musicProfile,'comments',array('label'=>'Notes/Comments')); ?></td>
					</thead>
					<tr>
					<td colspan="4"><?php echo CHtml::textField('MusicProfile[{0}][comments]','',array('size'=>80,'maxlength'=>100)); ?></td>
					</tr>
		...
		<?php for($i = 0 ; $i< count($music); $i++){ ?>
			...
			<td>			
				<table width="100%" height="100" style="border:#459E00 1px solid; background:#D2F4D3;padding:10px;">
					...
					<tr>
					<td colspan="4"><?php echo CHtml::textField('MusicProfile[{'.$i.'}][comments]',$music[$i]->comments,array('size'=>80,'maxlength'=>100)); ?></td>
					</tr>
					<!--GIve the Break to for Space between each table-->
					<br/>
				</table>
