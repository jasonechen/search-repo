		...
		<tr class="templateContent">  	
			<td>			
				<table width="100%" height="100" style="border:#459E00 1px solid; background:#D2F4D3;padding:10px;">
					...
					<tr >
						<td><?php echo CHtml::dropdownList('WorkProfile[{0}][year_begin]','',WorkProfile::$YearParticipateArray,array('prompt'=>'Enter Begin Year','class'=>'req from')); ?>
							<?php $this->ErrorDiv('WorkProfile_{0}_year_beginError','From'); ?>
						</td>
						<td><?php echo CHtml::dropdownList('WorkProfile[{0}][year_end]','',WorkProfile::$YearParticipateArray,array('prompt'=>'Enter End Year','class'=>'req to')); ?>
		...
		<?php for($i = 0 ; $i< count($work); $i++){ ?>
			...
			<td>			
				<table width="100%" height="100" style="border:#459E00 1px solid; background:#D2F4D3;padding:10px;">
					...
					<tr >
						<td><?php echo CHtml::dropdownList('WorkProfile[{'.$i.'}][year_begin]',$work[$i]->year_begin,WorkProfile::$YearParticipateArray,array('prompt'=>'Enter Begin Year','class'=>'req from')); ?>
							<?php $this->ErrorDiv('WorkProfile_'.$i.'_year_beginError','From'); ?>

						</td>
						<td><?php echo CHtml::dropdownList('WorkProfile[{'.$i.'}][year_end]',$work[$i]->year_end,WorkProfile::$YearParticipateArray,array('prompt'=>'Enter End Year','class'=>'req to')); ?>
					...
					<thead>
						<td colspan="3"><?php echo $form->labelEx($workProfile,'comments',array('label'=>'Notes/Comments')); ?></td>
