...
<div class="sub-head-profile-edit">Academics - Honors/Advanced Courses Taken</div>
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<tr >  
	<td  colspan="4"> 
	<div class="addRow add"><img alt="plus" src="images/plus.png" style="padding-left:10px;padding-right:0;"><?php echo Yii::t('ui','Add Subject');?></div>
