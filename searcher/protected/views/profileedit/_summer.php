...
?>
<div class="sub-head-profile-edit">Extracurriculars - Summer</div>
<div class="container summer">
	...
	<tr >  
	<td  colspan="3"> 
	<div class="addRow add"><img alt="plus" src="images/plus.png" style="padding-left:10px;padding-right:0;"><?php echo Yii::t('ui','Add Summer Activity');?></div>
			...
			<td>			
				<table class="formbox" width="100"  height="100" style="border:#DDDDDD 1px solid; background:#E0F3E0;padding:8px;">
					<thead class="templateHead">
						...
						<td><?php echo $form->label($summerProfile,'summer_date',array('label'=>'Summer Between')); ?> </td>
					...
					<tr> 	
						...
						<td><?php echo CHtml::textField('SummerProfile[{0}][comments]','',array('size'=>50,'maxlength'=>70)); ?> </td>
					</tr>
			...
			<td>			
				<table class="formbox" width="100"  height="100" style="border:#DDDDDD 1px solid; background:#E0F3E0;padding:8px;">
					...
					<tr> 	
						...
						<td><?php echo CHtml::textField('SummerProfile[{'.$i.'}][comments]',$summer[$i]->comments,array('size'=>50,'maxlength'=>70)); ?> </td>
					</tr>
	...
	<?php } ?>		
        ...
        <div class="span-24 last"><br></br></div>
