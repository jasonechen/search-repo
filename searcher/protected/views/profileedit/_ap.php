...
<?php
 ...
 ?>
<div class="sub-head-profile-edit">Test Scores - AP</div>
<div class="container">
...
<?php 
	...
	<tr >  
	<td  colspan="4"> 
	<div class="addRow add"><img alt="plus" src="images/plus.png" style="padding-left:10px;padding-right:0;"><?php echo Yii::t('ui','Add AP Test');?></div>
