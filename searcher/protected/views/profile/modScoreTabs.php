...
$this->widget('zii.widgets.jui.CJuiTabs', array(
    'tabs'=>array(
        'SAT I'=>$this->renderPartial('_scores_sat1', array('academicProfile'=>$academicProfile,'scoreProfile'=>$scoreProfile), true),
        ...
        'PSAT'=>$this->renderPartial('_scores_psat', array('academicProfile'=>$academicProfile,'scoreProfile'=>$scoreProfile), true),        
