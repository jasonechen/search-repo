...
@Author:         Altered by Egor Smirnov - egorsmir@gmail.com
...
(function($) {
	$.fn.jRating = function(op) {
		var defaults = {
            ...
            /** Comments for rating if needed **/
                
            enableComments: false,
            enableCommentsId: '',
            enableCommentsSubmitId: '',
            csrfToken: '',
			...
			$(this).unbind('click').bind({
				...
				click : function(e){
                    ...
                    /*if(opts.enableComments && $(opts.enableCommentsId).val() === '')
                    {
                        ...
                        $(opts.enableCommentsSubmitId).show().live('click', function() {
                            if($(opts.enableCommentsId).val() !== '')
                            {
                                postRatingValue = true;
