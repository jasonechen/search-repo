...
class CreditsPurchaseOrder extends CActiveRecord
{
   /**
	...
	{
		return 'tbl_credits_purchaseorder';
	}
	...
	public function rules()
	{
		...
		return array(
			array('bill_fname,bill_address1,bill_city,bill_state,bill_postal_code', 'required'),
			array('bill_fname', 'length', 'max'=>128),
