...
/**
 * This is the model class for table "tbl_seller_curr_view".
 *
 * The followings are the available columns in table 'tbl_seller_curr_view':
 * @property string $id
 ...
 */
class SellerCurrView extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('user_id, buyer_id, trans_type, payment,usedRoyalty', 'required'),
			...
			array('id, user_id, buyer_id, trans_type, payment, useRoyalty, purchase_date', 'safe', 'on'=>'search'),
		);
	}
